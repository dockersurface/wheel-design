...
import { b as classnames } from './index2.js';
import { i as isInContainer, g as getScrollContainer, a as getClassPrefix } from './utils.js';
...
const WImage$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  components.forEach(tagName => { switch (tagName) {
    case "w-image":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WImage$1);
      }
      break;
  } });
}

const WImage = WImage$1;
const defineCustomElement = defineCustomElement$1;

export { WImage, defineCustomElement };
