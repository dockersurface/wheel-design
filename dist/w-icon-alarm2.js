...
const WIconAlarm = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  components.forEach(tagName => { switch (tagName) {
    case "w-icon-alarm":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WIconAlarm);
      }
      break;
  } });
}

export { WIconAlarm as W, defineCustomElement as d };
