...
const index$1 = require('./index-956d91b4.js');
...
const WImage = class {
  ...
  handleLazyLoad() {
    if (this.show)
      return;
    if (utils.isInContainer(this.element, this._scrollContainer)) {
      this.show = true;
    }
  }
  componentWillLoad() {
    ...
    this._scrollContainer = utils.getScrollContainer(this.element);
  ...
  render() {
    ...
    const classPrefix = utils.getClassPrefix('image');
    const classes = index$1.classnames(classPrefix);
