...
const WIcon$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["w-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "w-icon":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WIcon$1);
      }
      break;
  } });
}
...
export { WIcon, defineCustomElement };
